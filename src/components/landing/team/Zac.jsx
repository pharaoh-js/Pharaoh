  ...
  render() {
    return (
      <InlineCss componentName="Card" stylesheet={stylesheet}>
        ...
        <li>Github:
          <a className="links" href="https://github.com/zacanger">here</a>
        </li>
        <li>Linkedin:
          <a className="links" href="https://www.linkedin.com/in/zacanger">here</a>
        </li>
        <li>Portfolio Site:
          <a className="links" href="http://zacanger.com">here</a>
        </li>
      </InlineCss>
    )
  }
